...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 16,
        center: new google.maps.LatLng(-30.0350993, -51.2265899), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(-30.0350993, -51.2265899) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>Internet of Things Conf 2016</b><br/>Rua Coronel Genuíno, 130<br/> Centro, Porto Alegre - RS"  //add your address
    });
